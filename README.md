...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-izc0nze.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-izc0nze.containers.anotherwebservice.com/
...
```
git clone git@github.com:horriblename/container-izc0nze.git
cd container-izc0nze
```
...
```
docker attach container-izc0nze
```
